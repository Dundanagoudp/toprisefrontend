...
export default function PrivacyPolicy() {
    ...
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="relative container mx-auto px-4">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold">Privacy Policy</h1>
        </div>
      </div>
  ...
  <div className="space-y-9">
    ...
    <section>
      ...
      <p className="text-[#61656A] text-xl font-sans leading-relaxed">You may disable cookies in your browser, but this may limit certain features.</p>
    </section>
    ...
    <section>
      ...
      <p className="text-[#61656A] text-xl font-sans leading-relaxed">However, no digital system is 100% secure. You use the Platform at your own risk.</p>
    </section>
    ...
    <section>
      ...
      <p className="text-[#61656A] text-xl font-sans leading-relaxed">Write to us at <span className="font-semibold">[insert email]</span> to exercise any of the above rights.</p>
    </section>
    ...
    <section>
      ...
      <p className="text-[#61656A] text-xl font-sans leading-relaxed">We are committed to resolving complaints within 15 working days.</p>
    </section>
  </div>
</div>
        </div>
