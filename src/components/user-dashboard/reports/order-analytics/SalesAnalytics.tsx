...
import { SalesAnalyticsResponse } from "@/types/order-analytics-types";
...
export default function SalesAnalytics({ data }: SalesAnalyticsProps) {
  if (!data) {
    return (
  ...
  const { summary, salesAnalytics } = data.data;
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Sales Analytics Details</CardTitle>
        </CardHeader>
        <CardContent>
          {salesAnalytics.length > 0 ? (
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead>Date/Group</TableHead>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <h4 className="font-medium mb-3">Tax & Charges</h4>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between">
                  <span>Total GST:</span>
