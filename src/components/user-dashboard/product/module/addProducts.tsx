  ...
  return (
    <div className="flex-1 p-4 md:p-6 bg-(neutral-100)-50 min-h-screen">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl md:text-2xl font-semibold text-gray-900">Add Product</h1>
        ...
        <Card className="border-gray-200 shadow-sm">
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Input id="videoUrl" placeholder="Past Link" className="bg-gray-50 border-gray-200 rounded-[8px] p-4" {...register("videoUrl")} />
            ...
            <div className="space-y-2">
              ...
              <Select onValueChange={(value) => setValue("brouchureAvailable", value)} defaultValue="no">
        ...
        <Card className="border-gray-200 shadow-sm">
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <Select onValueChange={(value) => setValue("active", value)} defaultValue="yes">
