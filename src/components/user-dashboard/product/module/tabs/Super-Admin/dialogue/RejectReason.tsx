...
import { rejectProduct } from '@/service/product-Service'
...
export default function RejectReason( { isOpen, onClose }: RejectReasonProps) {
    ...
    const handleFormSubmit = useCallback(async (data: RejectReasonFormData) => {
      try {
        console.log("Reject reason form data:", data)

        // Create FormData for file upload
      const payload: any = {
      reason: data.reason,
      rejected_by: auth.user._id,
