...
export default function AddDealer() {
  const form = useForm<DealerFormValues>({
    ...
    defaultValues: {
      ...
      email: "",
      isActive: "",
      productCategoriesAllowed: "",
      uploadAccessEnabled: "",
      certifications: "",
      defaultMargin: "",
      slaType: "",
      slaMaxDispatchTime: "",
      lastUploadDate: "2025-06-25 12:43", // Example pre-filled
      lastFulfillmentDate: "2025-06-25 12:43", // Example pre-filled
      assignedTopriseEmployee: "",
      onboardingDate: "",
      remarks: "",
    },
  })
